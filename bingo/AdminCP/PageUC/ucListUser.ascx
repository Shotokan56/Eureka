<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ucListUser.ascx.cs" Inherits="bingo.AdminCP.PageUC.ucListUser" %>
        ...
        <td>
            <asp:GridView ID="gvUser" runat="server" AutoGenerateColumns="False" BackColor="White"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="YahooIM" HeaderText="Yahoo" />
                    <asp:TemplateField>
                        <ItemTemplate>
