...
namespace bingo.DAL
{
    ...
    public class sysConfigDAL : BaseDAL
    {
        ...
        public int Insert(sysConfigDO objsysConfigDO)
        {
            ...
            Sqlparam = new SqlParameter("@eConfigValue", SqlDbType.NText);
            Sqlparam.Value = objsysConfigDO.eConfigValue;
            Sqlcomm.Parameters.Add(Sqlparam);
        ...
        public sysConfigDO Select(sysConfigDO objsysConfigDO)
        {
            ...
            if (ds != null && ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (!Convert.IsDBNull(dr["eConfigValue"]))
                    objsysConfigDO.eConfigValue = Convert.ToString(dr["eConfigValue"]);
        ...
        public int UpdateURL(string s)
        {

            SqlCommand Sqlcomm = new SqlCommand();
            Sqlcomm.CommandType = CommandType.StoredProcedure;
            Sqlcomm.CommandText = "spsysConfig_UpdateURLVideo";
            SqlParameter Sqlparam;
